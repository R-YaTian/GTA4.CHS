...
public:
    ...
    static void PrintCHSCharFreetype(float x, float y, GTAChar chr);
    static float GetCHSCharacterWidthFreetype(GTAChar chr);
    static float GetCHSCharacterSizeNormalFreetype(GTAChar chr);
    static float GetCHSCharacterSizeDrawingFreetype(GTAChar chr, bool use_extra_width);
#endif
